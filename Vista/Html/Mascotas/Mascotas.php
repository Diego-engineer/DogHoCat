    ...
    <div class="swiper-wrapper">
        ...
        while ($fila = mysqli_fetch_assoc($result)) {
            ...
            <div class="swiper-slide">
                <div class="icons">
                    <i class="fa-solid fa-circle-arrow-left"> <a href="/Vista/Html/Inicio/Administrador.php">..</a></i>
                ...
                <div class="mascota-content">
                    <div class="mascota-txt">
                        ...
                        <center> <a href="../Mascotas/Formulario.php" style="display: inline-block; padding: 13px 55px; border: 1px solid skyblue; border-radius: 25px; color: skyblue; text-decoration: none;"> Adoptar </a>  </center>
                    </div>
