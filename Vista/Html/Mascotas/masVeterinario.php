            ...
            <div class="swiper-slide">
                ...
                <div class="mascota-content">
                    <div class="mascota-txt">
                        ...
                        <center> <a href="/Vista/Html/Inicio/control.html" style="display: inline-block; padding: 13px 55px; border: 1px solid skyblue; border-radius: 25px; color: skyblue; text-decoration: none;"> Examinar </a>  </center>
                    </div>
