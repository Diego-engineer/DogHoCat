...
$pdf = new MYPDF(PDF_PAGE_ORIENTATION, PDF_UNIT, array(900, 700), true, 'UTF-8', false);

$pdf->SetMargins(0, PDF_MARGIN_TOP, PDF_MARGIN_RIGHT);
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('DogoCat');
$pdf->SetTitle('Reporte de Mascotas');
$pdf->SetSubject('Dogocat');
$pdf->SetHeaderMargin(9); 
$pdf->SetHeaderData('icono.jpg', 200, 'Reporte de Mascotas', 'Lista de las mascotas registradas en DogoCat');
...
$header = array('ID', 'Tipo', 'Nombre', 'Edad', 'Raza', 'Tamaño', 'Color', 'Sexo', 'Foto');
...
$pdf->Output('Reporte De Mascotas.pdf');
?>