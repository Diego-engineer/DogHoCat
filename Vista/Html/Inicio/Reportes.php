...
$pdf->SetHeaderData('icono.jpg', 200, 'Reporte de Usuarios', 'Lista de los usuarios registrador con rol determinado de DogoCat');
...
$header = array('ID', 'Documento', 'Nombres', 'Apellidos', 'Ciudad', 'Direccion', 'Correo', 'Telefono', 'Rol', 'Contraseña');
